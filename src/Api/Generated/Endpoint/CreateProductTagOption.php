...
class CreateProductTagOption extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7Endpoint
{
    ...
    {
        return '/product-tags/{productTagId}/options';
    }
    ...
    protected function transformResponseBody(string $body, int $status, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType)
    {
        ...
        if (400 === $status) {
            throw new \Starweb\Api\Generated\Exception\CreateProductTagOptionBadRequestException();
        }
        if (405 === $status) {
            throw new \Starweb\Api\Generated\Exception\CreateProductTagOptionMethodNotAllowedException();
        }
    }
}