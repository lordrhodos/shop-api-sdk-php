...
class PatchProductsBundledProduct extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7Endpoint
{
    ...
    {
        return '/products/{productId}/bundled-products/{bundledProductId}';
    }
    ...
    protected function transformResponseBody(string $body, int $status, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType)
    {
        ...
        if (400 === $status) {
            throw new \Starweb\Api\Generated\Exception\PatchProductsBundledProductBadRequestException();
        }
        if (404 === $status) {
            throw new \Starweb\Api\Generated\Exception\PatchProductsBundledProductNotFoundException();
        }
    }
}