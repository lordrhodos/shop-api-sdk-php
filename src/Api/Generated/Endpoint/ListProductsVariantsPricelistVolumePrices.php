...
class ListProductsVariantsPricelistVolumePrices extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7Endpoint
{
    ...
    {
        return '/products/{productId}/variants/{variantId}/prices/{pricelistId}/volume';
    }
    ...
    protected function transformResponseBody(string $body, int $status, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType)
    {
        ...
        if (400 === $status) {
            throw new \Starweb\Api\Generated\Exception\ListProductsVariantsPricelistVolumePricesBadRequestException();
        }
    }
}