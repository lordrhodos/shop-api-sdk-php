...
class CreateOrderItem extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
     ...
     */
    public function __construct(int $orderId, \Starweb\Api\Client\Model\OrderItemModel $requestBody)
    {
    ...
    {
        return str_replace(['{orderId}'], [$this->orderId], '/orders/{orderId}/items');
    }
