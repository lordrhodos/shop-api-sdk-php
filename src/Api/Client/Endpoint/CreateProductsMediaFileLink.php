...
class CreateProductsMediaFileLink extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
     ...
     */
    public function __construct(int $productId, \Starweb\Api\Client\Model\ProductMediaFileLinkModel $requestBody)
    {
    ...
    {
        return str_replace(['{productId}'], [$this->productId], '/products/{productId}/media-files');
    }
