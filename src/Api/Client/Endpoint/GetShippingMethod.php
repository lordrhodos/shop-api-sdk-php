...
class GetShippingMethod extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
    ...
    {
        return str_replace(['{shippingMethodId}'], [$this->shippingMethodId], '/shipping-methods/{shippingMethodId}');
    }
     ...
     *
     * @return \Starweb\Api\Client\Model\ShippingMethodModelItem|null
     */
