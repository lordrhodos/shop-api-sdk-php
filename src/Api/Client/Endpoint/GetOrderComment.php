...
class GetOrderComment extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
    ...
    {
        return str_replace(['{orderId}', '{commentId}'], [$this->orderId, $this->commentId], '/orders/{orderId}/comments/{commentId}');
    }
     ...
     *
     * @return \Starweb\Api\Client\Model\OrderCommentModelItem|null
     */
