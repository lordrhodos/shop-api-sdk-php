...
class GetCustomerExternalServices extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
    ...
    {
        return str_replace(['{customerId}'], [$this->customerId], '/customers/{customerId}/external-services');
    }
     ...
     *
     *
     * @return \Starweb\Api\Client\Model\CustomerExternalServicesModelCollection|null
     */
