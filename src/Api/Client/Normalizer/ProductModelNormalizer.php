...
class ProductModelNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Starweb\\Api\\Client\\Model\\ProductModel';
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Starweb\Api\Client\Model\ProductModel;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Starweb\Api\Client\Model\ProductModel();
        ...
        if (property_exists($data, 'variants')) {
            $object->setVariants($this->denormalizer->denormalize($data->{'variants'}, 'Starweb\\Api\\Client\\Model\\ProductVariantModelCollection', 'json', $context));
        }
        if (property_exists($data, 'mediaFiles')) {
            $object->setMediaFiles($this->denormalizer->denormalize($data->{'mediaFiles'}, 'Starweb\\Api\\Client\\Model\\ProductMediaFileLinkModelCollection', 'json', $context));
        }
        if (property_exists($data, 'languages')) {
            $object->setLanguages($this->denormalizer->denormalize($data->{'languages'}, 'Starweb\\Api\\Client\\Model\\ProductLanguageModelCollection', 'json', $context));
        }
        if (property_exists($data, 'vatRates')) {
            $object->setVatRates($this->denormalizer->denormalize($data->{'vatRates'}, 'Starweb\\Api\\Client\\Model\\ProductVatRateModelCollection', 'json', $context));
        }
        if (property_exists($data, 'categories')) {
            $object->setCategories($this->denormalizer->denormalize($data->{'categories'}, 'Starweb\\Api\\Client\\Model\\ProductCategoryLinkModelCollection', 'json', $context));
        }
        if (property_exists($data, 'unit')) {
            $object->setUnit($this->denormalizer->denormalize($data->{'unit'}, 'Starweb\\Api\\Client\\Model\\ProductUnitModelItem', 'json', $context));
        }
        if (property_exists($data, 'metaData')) {
            $object->setMetaData($this->denormalizer->denormalize($data->{'metaData'}, 'Starweb\\Api\\Client\\Model\\ProductMetaDataModelCollection', 'json', $context));
        }
