...
class CustomerModelNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Starweb\\Api\\Client\\Model\\CustomerModel';
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Starweb\Api\Client\Model\CustomerModel;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Starweb\Api\Client\Model\CustomerModel();
        ...
        if (property_exists($data, 'tags')) {
            $object->setTags($this->denormalizer->denormalize($data->{'tags'}, 'Starweb\\Api\\Client\\Model\\CustomerTagModelCollection', 'json', $context));
        }
        if (property_exists($data, 'addresses')) {
            $object->setAddresses($this->denormalizer->denormalize($data->{'addresses'}, 'Starweb\\Api\\Client\\Model\\CustomerAddressesModelCollection', 'json', $context));
        }
        if (property_exists($data, 'externalServices')) {
            $object->setExternalServices($this->denormalizer->denormalize($data->{'externalServices'}, 'Starweb\\Api\\Client\\Model\\CustomerExternalServicesModelCollection', 'json', $context));
        }
