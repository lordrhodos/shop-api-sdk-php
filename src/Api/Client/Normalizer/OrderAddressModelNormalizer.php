...
class OrderAddressModelNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Starweb\\Api\\Client\\Model\\OrderAddressModel';
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Starweb\Api\Client\Model\OrderAddressModel;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Starweb\Api\Client\Model\OrderAddressModel();
        if (property_exists($data, 'originalInvoice')) {
            $object->setOriginalInvoice($this->denormalizer->denormalize($data->{'originalInvoice'}, 'Starweb\\Api\\Client\\Model\\AddressModel', 'json', $context));
        }
        if (property_exists($data, 'originalDelivery')) {
            $object->setOriginalDelivery($this->denormalizer->denormalize($data->{'originalDelivery'}, 'Starweb\\Api\\Client\\Model\\AddressModel', 'json', $context));
        }
        if (property_exists($data, 'customerInvoice')) {
            $object->setCustomerInvoice($this->denormalizer->denormalize($data->{'customerInvoice'}, 'Starweb\\Api\\Client\\Model\\AddressModel', 'json', $context));
        }
        if (property_exists($data, 'customerDelivery')) {
            $object->setCustomerDelivery($this->denormalizer->denormalize($data->{'customerDelivery'}, 'Starweb\\Api\\Client\\Model\\AddressModel', 'json', $context));
        }
        if (property_exists($data, 'paymentMethodInvoice')) {
            $object->setPaymentMethodInvoice($this->denormalizer->denormalize($data->{'paymentMethodInvoice'}, 'Starweb\\Api\\Client\\Model\\AddressModel', 'json', $context));
        }
        if (property_exists($data, 'paymentMethodDelivery')) {
            $object->setPaymentMethodDelivery($this->denormalizer->denormalize($data->{'paymentMethodDelivery'}, 'Starweb\\Api\\Client\\Model\\AddressModel', 'json', $context));
        }
