...
class OrderModelNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Starweb\\Api\\Client\\Model\\OrderModel';
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Starweb\Api\Client\Model\OrderModel;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Starweb\Api\Client\Model\OrderModel();
        ...
        if (property_exists($data, 'items')) {
            $object->setItems($this->denormalizer->denormalize($data->{'items'}, 'Starweb\\Api\\Client\\Model\\OrderItemModelCollection', 'json', $context));
        }
        if (property_exists($data, 'addresses')) {
            $object->setAddresses($this->denormalizer->denormalize($data->{'addresses'}, 'Starweb\\Api\\Client\\Model\\OrderAddressCollection', 'json', $context));
        }
        if (property_exists($data, 'externalServices')) {
            $object->setExternalServices($this->denormalizer->denormalize($data->{'externalServices'}, 'Starweb\\Api\\Client\\Model\\OrderExternalServiceModelCollection', 'json', $context));
        }
        if (property_exists($data, 'customer')) {
            $object->setCustomer($this->denormalizer->denormalize($data->{'customer'}, 'Starweb\\Api\\Client\\Model\\CustomerModelItem', 'json', $context));
        }
        if (property_exists($data, 'status')) {
            $object->setStatus($this->denormalizer->denormalize($data->{'status'}, 'Starweb\\Api\\Client\\Model\\OrderStatusModelItem', 'json', $context));
        }
